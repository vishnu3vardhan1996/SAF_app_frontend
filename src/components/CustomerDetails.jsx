...
function CustomerDetails() {
    ...
    return (
        ...
        <div>
            <form align="center" action="https://sri-abirami-finance-backend.onrender.com/registration" method="POST">
...
{/* <label for="cust_no_id">Card no: <span className="required">* </span></label>
                    <input type="text" id="cust_no_id" name="custno" required></input>

                    <label for="date_id">Date: <span className="required">* </span></label>
                    <input type="date" id="date_id" name="date" required></input>

                    <label for="amount_id">Amount: <span className="required">* </span></label>
                    <input type="text" id="amount_id" name="amount" required></input>

                    <label for="name_id">Name: <span className="required">* </span></label>
                    <input type="text" id="name_id" name="name" required></input>

                    <label for="hus_fat_name_id">Husband/Father Name: <span className="required">* </span></label>
                    <input type="text" id="hus_fat_name_id" name="hus_fat_name" required></input>

                    <label for="address_id">Address: <span className="required">* </span></label>
                    <input type="text" id="address_id" name="address" required></input>

                    <label for="phone_no_id">Phone no: <span className="required">* </span></label>
                    <input type="text" id="phone_no_id" name="phone_no" required></input>

                    <label for="gold_det_id">Gold details: <span className="required">* </span></label>
                    <input type="text" id="gold_det_id" name="gold_det" required></input>

                    <label for="gold_grams_id">Gold grams: <span className="required">* </span></label>
                    <input type="text" id="gold_grams_id" name="gold_grams" required></input>

                    <label for="gold_value_id">Gold Actual Value : <span className="required">* </span></label>
                    <input type="text" id="gold_value_id" name="gold_value" required></input>

                    <label for="attender_id">Attender: <span className="required">* </span></label>
                    <input type="text" id="attender_id" name="attender" required></input>

                    <label for="aadhar_id">Aadhar Number: </label>
                    <input type="text" id="aadhar_id" name="aadhar"></input>
